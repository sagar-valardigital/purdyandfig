/******/ (() => {
  ...
  \**************************************************/
      /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        const __exportStar = (target, module, desc) => {
        ...
        const require_shared_cjs = __commonJS((exports) => {
          "use strict";
        ...
        const require_shared = __commonJS((exports, module) => {
          "use strict";
          if (false) {
          } else {
        ...
        const require_reactivity_cjs = __commonJS((exports) => {
          "use strict";
          Object.defineProperty(exports, "__esModule", { value: true });
          ...
          const convert = (val) => (shared.isObject(val) ? reactive3(val) : val);
          function isRef(r) {
        ...
        const require_reactivity = __commonJS((exports, module) => {
          "use strict";
          if (false) {
          } else {
          ...
          const thisProxy = new Proxy(
            {},
            {
              ...
              set: (target, name, value) => {
                const closestObjectWithKey = objects.find((obj) => obj.hasOwnProperty(name));
...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`,
        ...
        function directives(el, attributes, originalAttributeOverride) {
          ...
          const directives2 = Array.from(attributes)
            .map(
        ...
        const import_reactivity9 = __toModule(require_reactivity());
        ...
        magic("watch", (el) => (key, callback) => {
          const evaluate2 = evaluateLater(el, key);
          let firstTime = true;
          let oldValue;
          effect(() =>
            evaluate2((value) => {
        ...
        directive("model", (el, { modifiers, expression }, { effect: effect3, cleanup }) => {
          ...
          const evaluateAssignment = evaluateLater(el, assignmentExpression);
          const event =
            ...
            modifiers.includes("lazy")
              ? "change"
              : "input";
          const assigmentFunction = generateAssignmentFunction(el, modifiers, expression);
        ...
        function loop(el, iteratorNames, evaluateItems, evaluateKey) {
          const isObject = (i) => typeof i === "object" && !Array.isArray(i);
          const templateEl = el;
          evaluateItems((items) => {
        ...
        /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = function () {
          return {
            ...
            play: function play() {
              ...
              let counter = this.active; // run every this.interval milliseconds
  ...
  \***********************/
      /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        __webpack_require__.r(__webpack_exports__);
        /* harmony import */ const alpinejs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! alpinejs */ "./node_modules/alpinejs/dist/module.esm.js"
        );
        /* harmony import */ const _alpinejs_persist__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! @alpinejs/persist */ "./node_modules/@alpinejs/persist/dist/module.esm.js"
          );
        /* harmony import */ const _Slider_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ./Slider.js */ "./src/js/Slider.js"
        );

        window.Alpine = alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"];
        alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].plugin(
          _alpinejs_persist__WEBPACK_IMPORTED_MODULE_1__["default"]
        );
        alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data(
          "Slider",
          _Slider_js__WEBPACK_IMPORTED_MODULE_2__["default"]
        );
  ...
  /******/ (() => {
    ...
    /******/
    /******/ const chunkLoadingGlobal = (self["webpackChunkshopify_sunrise"] =
      self["webpackChunkshopify_sunrise"] || []);
  ...
  /******/ let __webpack_exports__ = __webpack_require__.O(undefined, ["assets/app"], () =>
